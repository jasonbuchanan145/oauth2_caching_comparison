...
@Configuration
@Slf4j
public class MemcachedConfig implements DisposableBean {
    ...
    public CacheManager memcachedCacheManager() throws IOException {
        ...
        MemcachedCache blacklistedTokensCache = new MemcachedCache("oauth2-clients", memcachedClient, 3600);
    ...
    public void destroy() throws Exception {
        if (memcachedClient != null) {
            try {
                ...
                log.info("Memcached client shut down successfully");
            } catch (IOException e) {
